...
class HuntMainActivity : AppCompatActivity() {
    ...
    // TODO: Step 2 add in variable to check if device is running Q or later //DONE
    private val runningQOrLater = android.os.Build.VERSION.SDK_INT >=
            android.os.Build.VERSION_CODES.Q

    // A PendingIntent for the Broadcast Receiver that handles geofence transitions.
    // TODO: Step 8 add in a pending intent //DONE
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: Step 9 instantiate the geofencing client // DONE
 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        // TODO: Step 5 add code to handle the result of the user's permission //DONE
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        // TODO: Step 6 add code to check that the device's location is on //DONE
     ...
     */
        ...
        //  permissions were approved //DONE
        @TargetApi(29)
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        // TODO: Step 4 add code to request foreground and background permissions //DONE
        if (foregroundAndBackgroundLocationPermissionApproved())
            return
    ...
    private fun addGeofenceForClue() {
        // TODO: Step 10 add in code to add the geofence //DONE
        if (viewModel.geofenceIsActive()) return
        ...
        // get the data of the current landmark
    ...
    private fun removeGeofences() {
        // TODO: Step 12 add in code to remove the geofences //DONE
        if (!foregroundAndBackgroundLocationPermissionApproved()) {
            return
        }
        geofencingClient.removeGeofences(geofencePendingIntent)?.run {
